-- DevinX Laser Control foundation.
-- PREPARED ONLY: do not apply until the correct DevinX Supabase project is positively identified.
-- Data lives in a non-exposed schema. Public/API access will be added later through narrowly scoped RPCs.
