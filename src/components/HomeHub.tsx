...
const COPY={
  ...
  es:{
    control:"DEVINX · TÚ TIENES EL CONTROL",choose:"Elige un producto.",chooseText:"Finanzas y Tienda son productos separados.",independent:"PRODUCTO INDEPENDIENTE",ownPlan:"Suscripción propia · no incluye el otro producto",or:"O",
  ...
  de:{
    control:"DEVINX · DU HAST DIE KONTROLLE",choose:"Wähle ein Produkt.",chooseText:"Finanzen und Shop sind getrennte Produkte.",independent:"EIGENSTÄNDIGES PRODUKT",ownPlan:"Eigenes Abo · enthält nicht das andere Produkt",or:"ODER",
  ...
  ar:{
    control:"DEVINX · أنت المتحكم",choose:"اختر منتجاً واحداً.",chooseText:"المالي والمتجر منتجان منفصلان.",independent:"منتج مستقل",ownPlan:"اشتراك مستقل · لا يشمل المنتج الآخر",or:"أو",
