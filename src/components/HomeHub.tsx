...
const COPY={
  "pt-BR":{
    ...
    chooseText:"Financeiro e Loja são produtos separados, cada um com seu próprio acesso e assinatura.",
  ...
  en:{
    control:"DEVINX · YOU'RE IN CONTROL",choose:"Choose one product.",chooseText:"Finance and Store are separate products, each with its own access and subscription.",independent:"INDEPENDENT PRODUCT",ownPlan:"Own subscription · does not include the other product",or:"OR",
  ...
  es:{
    control:"DEVINX · TÚ TIENES EL CONTROL",choose:"Elige un producto.",chooseText:"Finanzas y Tienda son productos separados, cada uno con su propio acceso y suscripción.",independent:"PRODUCTO INDEPENDIENTE",ownPlan:"Suscripción propia · no incluye el otro producto",or:"O",
  ...
  fr:{
    control:"DEVINX · VOUS GARDEZ LE CONTRÔLE",choose:"Choisissez un produit.",chooseText:"Finance et Boutique sont des produits séparés, chacun avec son propre accès et abonnement.",independent:"PRODUIT INDÉPENDANT",ownPlan:"Abonnement propre · n’inclut pas l’autre produit",or:"OU",
  ...
  de:{
    control:"DEVINX · DU HAST DIE KONTROLLE",choose:"Wähle ein Produkt.",chooseText:"Finanzen und Shop sind getrennte Produkte, jeweils mit eigenem Zugang und Abo.",independent:"EIGENSTÄNDIGES PRODUKT",ownPlan:"Eigenes Abo · enthält nicht das andere Produkt",or:"ODER",
  ...
  ar:{
    control:"DEVINX · أنت المتحكم",choose:"اختر منتجاً واحداً.",chooseText:"المالي والمتجر منتجان منفصلان، ولكل منهما وصول واشتراك خاص.",independent:"منتج مستقل",ownPlan:"اشتراك مستقل · لا يشمل المنتج الآخر",or:"أو",
